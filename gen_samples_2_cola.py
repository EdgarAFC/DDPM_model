...
################################
file_loss = open("/mnt/nfs/efernandez/projects/DDPM_model/log_sampling_w2_cola.txt", "w")
file_loss.close()
################################
def write_to_file(input): 
    with open("/mnt/nfs/efernandez/projects/DDPM_model/log_sampling_w2_cola.txt", "a") as textfile: 
...
def main():
    ...
    save_dir = '/mnt/nfs/efernandez/trained_models/DDPM_model/v7_TT_50epoch_gen'
