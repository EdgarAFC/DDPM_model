...
################################
file_loss = open("/mnt/nfs/efernandez/projects/DDPM_model/log_sampling_w2.txt", "w")
file_loss.close()
################################
def write_to_file(input): 
    with open("/mnt/nfs/efernandez/projects/DDPM_model/log_sampling_w2.txt", "a") as textfile: 
