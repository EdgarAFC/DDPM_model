...
# save_dir = '/CODIGOS_TESIS/T2/trained_models/DDPM_model/v7_TT_50epoch'
...
for x, y in test_dataloader:
    ...
    generated_image = diffusion.p_sample_loop(model13A, y.shape, x, progress=True, clip_denoised=True)
