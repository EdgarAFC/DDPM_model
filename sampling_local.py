...
from model7 import UNETv14

device = torch.device("cuda:0" if torch.cuda.is_available() else torch.device('cpu'))
save_dir = '/CODIGOS_TESIS/T2/trained_models/DDPM_model/v1_TT'
# save_dir = '/CODIGOS_TESIS/TESIS2/Unet_models/v16'
training_epochs = 10#10
model13A = UNETv14(residual=True, attention_res=[], group_norm=True).to(device)
